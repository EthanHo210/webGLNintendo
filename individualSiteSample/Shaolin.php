...
<section id="game-detail" class="section-p1">
    <div class="slideShow-review">
        <div class="slideShow">
            <div class="slide">
                <img src="./img/shaolinj.jpg" alt="">
                <div class="text">1/5</div>
            </div>
            <div class="slide">
                <img src="./img/shaolin-10.png" alt="">
                <div class="text">2/5</div>
            </div>
            <div class="slide">
                <img src="./img/shaolin-02.png" alt="">
    ...
    <div class="review">
        <div class="review-info">
            ...
            <h4>Shaolin</h4>
            <span>Release date: 19 July, March 31, 2000</span>
            <br>
            <span>Genre: Adventure, action, fighting</span>
            <br>
            <div class="star">
                <span>Ratings: 
...
<div class="detail-review">
    <h3>Overview</h3>
    <span>From the slums of Shaolin, Wu-Tang clan strikes again! The RZA, The GZA, Ol' Dirty Bastard, U-God, Inspectah Deck, Method Man, Ghostface Killah, Raekwon the Chef and Masta Killa all come hard, so it's best to watch ya step kid, and to protect ya neck!
    </span>
</div>
...
<section id="review1" class="section-p1">
    ...
    <div class="pro-container">
        <div class="pro">
            <a href="./Conker.html"><img src="./img/Conkersbfdbox.jpg" alt=""></a>
            <div class="des">
                <div class="name">
