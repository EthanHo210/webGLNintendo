...
<section id="game-detail" class="section-p1">
    <div class="slideShow-review">
        <div class="slideShow">
            <div class="slide">
                <img src="./img/Super_Mario_64_Boxart.png" alt="">
                <div class="text">1/5</div>
            </div>
            <div class="slide">
                <img src="./img/SM64_CG_Peachscastle.png" alt="">
                <div class="text">2/5</div>
            </div>
            <div class="slide">
                <img src="./img/SM64_Screenshot_Whomp's_Fortress.png" alt="">
    ...
    <div class="review">
        <div class="review-info">
            ...
            <h4>Super Mario</h4>
            <span>Release date: April 5, 2023</span>
            <br>
            <span>Genre: Educational, puzzles, RPGs</span>
            <br>
            <div class="star">
                <span>Ratings: 
